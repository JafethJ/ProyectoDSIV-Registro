    ...
    <div id="form_datos_generales">
        ...
        <div id="container_cedula" class="d-flex align-items-center">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="inputNamel1" id="inputNamel1" placeholder="Primer Nombre" required>
            </div>
            <div class="col-md-6">
                <label for="inputNamel2" class="textColor" class="form-label">Segundo Nombre: </label>
                <input type="text" class="form-control" name="inputNamel2" id="inputNamel2" placeholder="Segundo Nombre">
            </div>
            <div class="col-md-6">
                <label for="inputLastNamel1" class="textColor" class="form-label">Primer Apellido: *</label>
                <input type="text" class="form-control" name="inputLastNamel1" id="inputLastNamel1" placeholder="Primer Apellido" required>
            </div>
            <div class="col-md-6">
                <label for="inputLastNamel2" class="textColor" class="form-label">Segundo Apellido: *</label>
                <input type="text" class="form-control" name="inputLastNamel2" id="inputLastNamel2" placeholder="Segundo Apellido" required>
            </div>
